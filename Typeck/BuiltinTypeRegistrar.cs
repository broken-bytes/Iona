...
/// <summary>
/// Registers Iona's builtin types (Int32, String, Bool, etc.) directly into the symbol table.
/// These map 1:1 to CLR primitives at the IL level (like Kotlin's kotlin.String → java.lang.String).
/// No Iona.Builtins.dll is needed — the compiler has built-in knowledge of these types.
/// </summary>
